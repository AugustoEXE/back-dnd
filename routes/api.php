...
Route::prefix('races')->middleware('auth')->group(function () {
...
Route::prefix('weapons')->middleware('auth')->group(function () {
...
Route::prefix('creatures')->middleware('auth')->group(function () {
...
Route::prefix('creature-types')->middleware('auth')->group(function () {
...
Route::prefix('magic-schools')->middleware('auth')->group(function () {
...
Route::prefix('rarities')->middleware('auth')->group(function () {
